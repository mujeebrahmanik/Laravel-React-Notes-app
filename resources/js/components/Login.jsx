  ...
  return (
    <div className="isolate min-h-screen rounded-xl bg-gray-900 px-6 py-26 sm:py-26 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Welcome Back</h2>
        <p className="mt-2 text-lg/8 text-gray-400">Sign in to continue</p>
      </div>

      {error && 
        <p className='text-red-400 font-semibold flex justify-center gap-3 items-center mt-3'><IoIosWarning /> {error}</p>
      }
